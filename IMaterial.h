...
// Also make sure you add/remove a string associated with each flag below to CShaderSysteShaderStateString in ShaderSystem.cpp
//-----------------------------------------------------------------------------
...
public:
	...
	// IMaterialSysteUncacheUnusedMaterials.
	...
	// Returns true if this is the error material you get back from IMaterialSysteFindMaterial if
